    ...
    <main className="flex bg-background flex-col min-h-screen items-center">
      <section className="flex flex-1 flex-col gap-4 justify-start p-4 items-start w-full md:w-auto md:justify-center">
        ...
        <p className="max-w-xl text-pretty font-mono text-secondary-foreground/80">
          I have successfully completed all three assignments with fully responsive design. I took
          the liberty to introduce a custom dark and light mode inspired by Daisy UI. Additionally,
          I added a floating navbar that hides on mouse leave and is initially hidden for the{' '}
